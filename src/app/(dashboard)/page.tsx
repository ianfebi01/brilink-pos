    ...
    <TransitionWrapper>
      <div className="space-y-8">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card className="animate-item bg-muted/40 border-none ring-0 shadow-none">
        ...
        <div className="grid gap-4 grid-cols-1 lg:grid-cols-7">
          <Card className="animate-item lg:col-span-4 bg-muted/40 border-none ring-0 shadow-none">
            <CardHeader>
          ...
          <Card className="animate-item lg:col-span-3 bg-muted/40 border-none ring-0 shadow-none">
            <CardHeader>
