  ...
  return (
    ...
    >
      ...
      <DialogContent 
        ...
        disableCssAnimation
        className="w-full max-w-full h-[100dvh] max-h-[100dvh] sm:h-auto sm:max-h-[calc(100vh-4rem)] p-4 sm:p-6 rounded-none sm:rounded-xl overflow-y-auto sm:max-w-[500px] flex flex-col origin-center"
      >
        <div ref={contentRef}
          className="contents"
        >
